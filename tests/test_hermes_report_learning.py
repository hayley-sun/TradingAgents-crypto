...
class HermesReportLearningTests(unittest.TestCase):
    ...
    def test_reflection_rejects_untrusted_content_before_index_write(self):
        unsafe_values = (
            ...
            ("overall_assessment", "secret=provider-value"),
            ("overall_assessment", "Authorization: Bearer provider-token-value"),
            ("overall_assessment", "authorization: bearer provider-token-value"),
    ...
    def test_maximal_chinese_rendering_is_bounded_in_chars_and_utf8_bytes(self):
        ...
        self.assertIn("evidence:", rendered.hermes_memory_entry)
        self.assertIn("confidence:", rendered.hermes_memory_entry)
        self.assertIn("report.market", rendered.hermes_memory_entry)
